...
# RoBERTa 모델 소스 분석
# 출처 : https://github.com/huggingface/transformers/blob/main/src/transformers/models/roberta/modeling_roberta.py
import math
...
class RobertaEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        # ===================================================================================
        # nn.Embedding (Look-up Table)
        # "A simple look-up table that stores embeddings of a fixed dictionary and size"
        # word_embedding : vocab_size x hidden_size
        # position_embedding : max_position x hidden_size
        # token_type_embeddings(Segment Embedding)
        ...
        # ===================================================================================
        # Store 'non-trainable' parameters. never be effected by optimize.(remained as consistent things.)
        # it is useful to deal with 'mask' that is not learnable.
